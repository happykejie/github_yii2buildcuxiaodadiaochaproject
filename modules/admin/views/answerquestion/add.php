    ...
    <div class="row">
        <div class="col-md-6">
            <div class="main">
                ...
                <?= $form->field($model,'askquestionid')->textinput();?>
                <?= $form->field($model,'answercontent')->textinput();?>
                <?= $form->field($model,'answertimelength')->textinput();?>
                <?= $form->field($model,'answertime')->textinput();?>
                <?= $form->field($model,'answerispass')->textinput();?>
