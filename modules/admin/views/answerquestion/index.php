                ...
                <div class="main">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?=$v->id?></td>
                            <td><?=$v->answertimelength?></td>
                            <td><?php if($v->askproblemone()->isopenask==1):?>
                                <? echo "已公开"?>
                                <?endif?>
                                <?php if($v->askproblemone()->isopenask==0):?>
                                <? echo "未公开"?>
                                <?endif?>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-danger btn-voice"  action="<?=Yii::$app->urlManager->createUrl(['admin/answerquestion/voice','id'=>$v->askquestionid])?>">语音列表</button></td>
                            <td>
                                <!-- <button class="btn btn-sm btn-danger btn-edit" id="" action="<?=Yii::$app->urlManager->createUrl(['admin/answerquestion/edit','id'=>$v->id])?>">编辑</button>-->
