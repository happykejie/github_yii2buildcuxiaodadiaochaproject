        ...
        <div class="col-md-6">
            <div class="main">
                ...
                <?php $form=ActiveForm::begin(['id'=>'add','enableAjaxValidation'=>false]); ?>
                 <?= $form->field($model,'answerpersonid')->textinput();?>
                 <?= $form->field($model,'asktime')->textinput();?>
                  <?= $form->field($model,'ispaysuccess')->textinput();?>
                 <?= $form->field($model,'askfee')->textinput();?>
                  <?= $form->field($model,'isanswer')->textinput();?>
                 <?= $form->field($model,'questionorder')->textinput();?>
                <?= $form->field($model,'questiondescription')->textarea(['rows'=>4]);?>
