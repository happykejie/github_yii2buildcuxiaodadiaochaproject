        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main">
                    <h2>组别管理</h2>
                    <div class="tool">
                        <button id="btn_add" class="btn btn-primary btn-sm" action="<?=Yii::$app->urlManager->createUrl('admin/incomecost/add')?>">新增组别</button>
                    </div>
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td><?=$v->id?></td>
                            <td>
                                <button class="btn btn-sm btn-danger btn-edit" id="" action="<?=Yii::$app->urlManager->createUrl(['admin/incomecost/edit','id'=>$v->id])?>">编辑</button>
                                <button class="btn btn-sm btn-danger btn-delete"  action="<?=Yii::$app->urlManager->createUrl(['admin/incomecost/delete','id'=>$v->id])?>">删除</button>
                            </td>
                        </tr>
                        <?endforeach?>
                        <?else:?>
