                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger btn-edit" id="" action="<?=Yii::$app->urlManager->createUrl(['admin/users/edit','id'=>$v->id])?>">编辑</button>
                                   <button class="btn btn-sm btn-danger btn-editpwd" id="" action="<?=Yii::$app->urlManager->createUrl(['admin/users/editpwd','id'=>$v->id])?>">密码修改</button>
                                
                                <button class="btn btn-sm btn-danger btn-delete"  action="<?=Yii::$app->urlManager->createUrl(['admin/user/delete','id'=>$v->id])?>">删除</button>
                            </td>
                        </tr>
                        <?endforeach?>
                        <?else:?>
