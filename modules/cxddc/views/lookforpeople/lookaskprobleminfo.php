...
<head>
    ...
    <?=Html::cssFile('@web/web/assets/cxddc/css/mui.min.css')?>
...
<body>
    <div class="mui-content" style=" position: relative;">
        ...
        <ul class="mui-table-view mui-table-view-striped mui-table-view-condensed">
            <li class="mui-table-view-cell">
                <a  class="mui-navigate-right" href="/cxddc/lookforpeople/expert?id=<?php echo $item->getUseranswer()->id?>">
                    <div class="mui-slider-cell">
                        <div class="oa-contact-cell mui-table">
	...
	$(function(){
		...
		$.ajax({
			            url: '/cxddc/lookforpeople/sendmsgtoteacher',
			            type: 'get',
