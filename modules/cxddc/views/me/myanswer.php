                        ...
                        <ul class="mui-table-view">
                                    ...
                                    <div class="mui-slider-cell myquer-maigntop ">
                                        <div class="oa-contact-cell mui-table">
                                            ...
                                            <div class="oa-contact-content mui-table-cell myq-right ">
											  <a href="/cxddc/cxddc/paywenda?id=<?=$v->id?>">
                            ...
                            <?else:?>
								...
								<!--	<div class="mui-button-row">
										<a href="/cxddc/lookforpeople/lookforpeople"><button type="button"  class="mui-btn-primary remind-button">去找人</button>
										</a>
									</div>-->
								</div>
                            </li>
                                        ...
                                        <div class="oa-contact-content mui-table-cell ">
                                         ...
                                         <?endif?>
                                            ...
                                            <button type="button" class="mui-btn huida mui-btn-primary" style="">
                                                <a href="/cxddc/cxddc/recordings?id=<?=$v->id?>">马上回答 </a>
                                            </button>
                                            <?endif?>
