...
class IndexController extends Controller{
    ...
    public function actionIndex($id = 1,$code=null){
        ...
        if( $this->_user ){
            ...
            {
                //返回错误登录页面
                Yii::$app->response->redirect(Url::to(['/wenda/index/errorlogin'],true));
                
                return;
            }
            
			Yii::$app->response->redirect(Url::to(['/wenda/cuxiao/loadad'],true));
        ...
        if($code){
            ...
            $returl="http://".WWW."/wenda/index";//Url::to(['/wx/wxapi/login'],true);
