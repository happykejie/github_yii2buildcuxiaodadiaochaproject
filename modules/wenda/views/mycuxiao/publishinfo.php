...
<body>
    ...
    <div class="mui-content" style="position: relative;">
        ...
        <div class="teacher-back">
                ...
                <?endif?>
                <?php $form=ActiveForm::begin(['id'=>'publishinfo','enableAjaxValidation'=>false]); ?>
				<div class="mui-content-padded">
						<h4 >活动名称(12字以内 )</h4>
					<?= $form->field($model,'title')->textarea(['rows'=>2,'maxlength'=>25,'placeholder'=>'阿欢阿杰科技促销平台']);?>
				</div>
				<div class="q"></div>
			...
			<div id='image-list' class="row image-list"></div>
                ...
                <?endif?>
                  ...
                  <div style="padding:10px;">
					<?php if($model->userstate<>1):?>
                        <?=Html::submitButton('提交审核',['id'=>'sub','class'=>'mui-btn mui-btn-primary mui-btn-block s','onclick'=>'return reg()'])?>
                     <?endif?>
